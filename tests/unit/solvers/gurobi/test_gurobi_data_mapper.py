...
def test_from_gurobi_result_extracts_selected_variables(gurobi_data_mapper, triangulation_problem_05):
    model = gurobi_data_mapper.to_gurobi_model(triangulation_problem_05)
    model.optimize()
